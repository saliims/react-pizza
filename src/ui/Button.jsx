...
export default function Button({ children, disabled, to, type, onClick }) {
  const base =
    "inline-block text-sm rounded-full bg-violet-400 font-semibold uppercase tracking-wide text-stone-800 transition-colors duration-300 hover:bg-violet-300 focus:outline-none focus:ring focus:ring-violet-300 focus:ring-offset-2 disabled:cursor-not-allowed";
  const styles = {
